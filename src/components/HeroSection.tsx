          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button
                ...
                className="px-8 py-4 rounded-lg transition-all duration-300 transform hover:scale-105 text-foreground glass-base border border-border hover:border-primary hover:shadow-[0_4px_15px_rgba(var(--color-primary-glow),0.3)] font-bold uppercase tracking-wider"
              >
                DOWNLOAD CV
              </button>
            </div>
