...
/**
 * Social icon link - pure CSS hover matching Figma
 * Hover: golden gradient fills circle, icon turns GOLDEN (--color-primary)
 */
export default function SocialIconLink({ href, label, children, className = "" }: SocialIconLinkProps) {
  return (
    <a
      href={href}
      target="_blank"
...
export function LinkedinIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" style={{ color: 'inherit' }}>
